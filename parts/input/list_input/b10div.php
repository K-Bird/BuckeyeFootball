...
<div class="row">
    <div class="col-lg-12">
        <table>
            <tr>
                <td>
                    <input id="addb10divName" class="form-control" placeholder="Enter New Division" style="width: 200px">
                </td>
            ...
            while ($fetchb10divData = $getb10divData->fetch_assoc()) {
                ...
                echo '<tr>';
                echo '<td><input class="form-control  editListItem" data-id="' . $fetchb10divData['Div_ID'] . '" data-idcol="Div_ID" data-table="b10_divisions" data-datacol="Div_Name" placeholder="' . $fetchb10divData['Div_Name'] . '" style="width: 200px"></td>';
